...
public class ResourceController : MonoBehaviour
{
    ...
    private void Start ()
    {
        ResourceButton.onClick.AddListener (() =>
        {
            ...
            if (IsUnlocked && GameManager.Instance._totalGold < upgradeCost)
            {
                SoundScript.PlaySound("notUpgrade");
            }
            else if(IsUnlocked && GameManager.Instance._totalGold > upgradeCost)
            {
                UpgradeLevel();
